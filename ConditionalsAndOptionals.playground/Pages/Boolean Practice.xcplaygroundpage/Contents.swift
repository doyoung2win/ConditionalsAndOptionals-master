...
let response = hasFish || hasPizza && hasVegan ? "Let's go!" : "Sorry, we'll have to think of somewhere else."
...
let isNiceWeather = !isRaining && temp >= 82 && isSunny ? "I'm going for a walk!" : "Fuck that!"
